    ...
    <section className="relative isolate flex h-[min(720px,100vh)] w-full items-center overflow-hidden rounded-2xl bg-[#1c0f2e]">
      ...
      <div className="relative z-20 flex w-full justify-start">
        <div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-16 text-left text-[#f8f1e8] sm:px-12 lg:px-20">
          <span className="max-w-fit text-xs font-bold uppercase tracking-[0.35em] text-amber-300">
            Kickaas Event Suite
          </span>
          <h1 className="font-extrabold text-4xl leading-tight sm:text-[52px] sm:leading-[1.1] lg:text-[64px]">
          ...
          <div className="flex flex-wrap items-center gap-5 pt-2">
            <Link
              href="/events"
              className="inline-flex items-center text-center justify-center rounded-full bg-[#5c1354] px-8 py-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#f8f1e8] shadow-lg shadow-[#5c1354]/40 transition duration-200 hover:-translate-y-0.5 hover:bg-[#6b1b62] hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f8f1e8]/50"
            >
              Explore Events
