...
export default function Landing({ cookie }: { cookie: string }) {
  return (
        ...
        <div className="relative min-h-[200vh] w-full overflow-x-hidden">
          ...
          <div className="absolute bottom-0 left-0 flex min-h-screen w-full flex-col gap-10 px-4 pb-20 pt-24 sm:px-6 md:flex-row md:items-center md:justify-between md:gap-14 md:px-12 lg:px-20">
            ...
            >
              <motion.span
                aria-hidden
                className="pointer-events-none absolute -top-24 -right-16 h-48 w-48 rounded-full bg-amber-300/50 blur-3xl dark:bg-amber-400/30"
              ...
              <p className="font-atkinson-hyperlegible-next w-full text-md font-semibold text-neutral-700 dark:text-neutral-200 wrap-break-word">
                From private parties to large conferences, Kickaas helps you
                create, manage, and enjoy events effortlessly.
              </p>
            ...
            >
              <motion.div className="grid h-full w-full grid-cols-1 gap-4 p-4 sm:grid-cols-2 lg:grid-cols-5 lg:grid-rows-5">
                <motion.div
                  className="col-span-1 overflow-hidden rounded-3xl border border-neutral-200/60 bg-white/85 p-6 shadow-lg shadow-amber-500/10 backdrop-blur dark:border-white/5 dark:bg-neutral-950/80 sm:col-span-2 lg:col-span-3 lg:row-span-3"
                  animate={{ y: [0, -10, 0] }}
                  transition={{
                    duration: 14,
                    repeat: Infinity,
                  ...
                  whileHover={{ y: -14, rotate: -1.2, scale: 1.01 }}
                >
                ...
                >
                  <motion.div
                    ...
                    className="h-full rounded-3xl border border-amber-500/40 bg-amber-500/10 p-5 text-amber-700 shadow-lg shadow-amber-400/10 dark:text-amber-200"
                  >
                ...
                <motion.div
                  ...
                  viewport={{ once: true, margin: "-20%" }}
                  className="col-span-1 sm:col-span-2 lg:col-span-2 lg:row-span-3"
                >
                  <motion.div
                    initial={{ y: 0, rotate: 0, scale: 1 }}
                    whileInView={{ y: [0, -16, 0] }}
                    viewport={{ once: false, amount: 0.6 }}
                    whileHover={{ y: -18, rotate: -1, scale: 1.02 }}
                    transition={{
                      y: {
                        duration: 15,
                        repeat: Infinity,
                    ...
                    className="flex h-full flex-col justify-between rounded-3xl border border-neutral-200/60 bg-white/90 p-5 text-neutral-900 shadow-lg shadow-amber-500/10 backdrop-blur dark:border-white/5 dark:bg-white/5 dark:text-neutral-100"
                  >
                    <div>
                ...
                <motion.div
                  ...
                  viewport={{ once: true, margin: "-20%" }}
                  className="col-span-1 sm:col-span-2 lg:col-span-3 lg:row-span-2"
                >
                  <motion.div
                    initial={{ y: 0, rotate: 0, scale: 1 }}
                    whileInView={{ y: [0, 10, 0] }}
                    viewport={{ once: false, amount: 0.6 }}
                    whileHover={{ y: -12, rotate: 1.2, scale: 1.02 }}
                    transition={{
                      y: {
                        duration: 13,
                        repeat: Infinity,
