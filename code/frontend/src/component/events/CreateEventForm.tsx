...
export function CreateEventForm({
  ...
  return (
    <div className="grid gap-10 lg:grid-cols-[1.6fr,1fr]">
      ...
      >
        ...
        {errors.length > 0 && (
          <motion.div
            ...
            className="mt-6 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-400/30 dark:bg-red-500/10 dark:text-red-200"
          >
        ...
        {status === "success" && (
          <motion.div
            ...
            initial={{ opacity: 0, y: -4 }}
            animate={{ opacity: 1, y: 0 }}
            className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700 dark:border-emerald-400/30 dark:bg-emerald-500/10 dark:text-emerald-200"
          >
      ...
      <motion.section
        layout
        className="flex h-full flex-col justify-between gap-6 rounded-3xl border border-neutral-200/70 bg-white/65 p-6 shadow-lg shadow-purple-500/10 backdrop-blur-md dark:border-white/10 dark:bg-neutral-900/40"
      >
        <div>
