...
import type { EventResponse, EventListResponse } from "@/services/events";
...
type EventsMock = jest.MockedFunction<
  (...args: unknown[]) => Promise<EventResponse[] | EventListResponse>
>;
